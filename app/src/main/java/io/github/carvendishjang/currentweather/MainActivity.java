package io.github.carvendishjang.currentweather;
...
public class MainActivity extends AppCompatActivity {
    ...
    public class DownloadTask extends AsyncTask<String, Void, String> {
        ...
        @Override
        protected String doInBackground(String... urls) {// Deal with the JSON data
            String result = "";
            URL url;
        ...
        @Override
        protected void onPostExecute(String s) { //Deal with JSON data
